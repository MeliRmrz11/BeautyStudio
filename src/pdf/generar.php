...
$total = mysqli_query($conexion, "SELECT * FROM ventas where id = $id");
$result_venta = mysqli_fetch_assoc($total);
$pdf->Cell(195, 5, utf8_decode($datos['nombre']), 0, 1, 'C');
$pdf->Image("../../assets/img/LogoB.png", 170, 5, 30, 30, 'PNG');
...
$pdf->Cell(25, 5, '', 0, 0, 'L');
$pdf->Cell(20, 5, '', 0, 0, 'L');
$pdf->Cell(35, 5, 'Total: $ ' . number_format($result_venta['total']) . '.00', 0, 1, 'L');
$pdf->SetFont('Arial', '', 10);
