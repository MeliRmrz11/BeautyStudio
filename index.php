...
<body style="background-color:#FF97C1;">
    <div id="layoutAuthentication">
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets/img/LogoB.png" width="150">
        ...
        <div id="layoutAuthentication_footer">
            <footer class="py-3 mt-auto" style="background-color:#F8ECD1;">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; <a href="#" target="_blank" rel="noopener noreferrer">Visite mi página web</a> <?php echo date("Y"); ?></div>
                        <!-- <div>
